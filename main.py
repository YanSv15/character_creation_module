...
def attack(char_name: str, char_class: str) -> str:
    """Назначает атаку в зависимости от персонажа."""
...
def special(char_name: str, char_class: str) -> str:
    """Фунция для назначения специального умения в зависимости от персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        char_class = input('Введи название персонажа, за которого хочешь игра'
                           'ть:Воитель — warrior Маг — mage, Лекарь — healer:')
        if char_class == 'warrior':
